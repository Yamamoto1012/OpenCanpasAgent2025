...
export const InfoSection: React.FC<InfoSectionProps> = ({ iconType, title, iconColor, children }) => {
  return (
    <section>
      <h3 className={`text-lg font-semibold mb-3 flex items-center ${iconColor ? iconColor : ""}`}>
        {iconMap[iconType]}
        {title}
      </h3>
      {children}
